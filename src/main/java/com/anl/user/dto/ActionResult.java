...
public class ActionResult implements Serializable {
	...
	public static ActionResult success(Object data , Object stamp , Boolean nextPage){
		int code = SystemErrorCode.success.getCode();
		
		ActionResult result = getResult(code , SystemErrorCode.getDescByCode(code) , data , stamp);
	...
	public static ActionResult fail() {
		int code = SystemErrorCode.error.getCode();
		
		return getResult(code , SystemErrorCode.getDescByCode(code) , null , null);
	}
	...
	public static ActionResult fail(int code , Object data) {
		return getResult(code , SystemErrorCode.getDescByCode(code) , data , null);
	}
