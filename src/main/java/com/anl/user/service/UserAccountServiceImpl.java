...
public class UserAccountServiceImpl implements UserAccountService {
    ...
    public int updateBalance(User user, UserAccountChangeHistory userAccountChangeHistory, int money) throws Exception {
        ...
        int primaryAccount = userAccount.getPrimaryAccount() == null ? 0 : userAccount.getPrimaryAccount(); // 主账户余额
        int subAccount = userAccount.getSubAccount() == null ? 0 : userAccount.getSubAccount(); // 子账户余额
