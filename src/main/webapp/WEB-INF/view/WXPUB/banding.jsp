...
<form id="form_sample_1" action="#" class="form-horizontal dialog" method="post"
    ...
    <label for="telNum" class="tel_label clear">
        ...
        <input type="hidden" name="cardId" value="${cardId}" id="cardId" />
...
<div class="tips">
    ...
    <p class="tip_error" id="errorType2">您的手机号已绑定，请更换号码重新输入</p>
    <p class="tip_error" id="errorType3">当前手机号未绑定大象卡，请填写开卡的手机号</p>
    <p class="tip_error" id="errorType4">绑定失败,手机号或验证码错误</p>
    <p class="tip_error" id="errorType5">手机号不能为空</p>
</div>
        ...
        $.ajax({            url: './userBanding',
            ...
            success: function (returndata) {
                if(returndata.code==1004){
                    ...
                    location.href = "./getAcCardSuccess";
                }
            },
